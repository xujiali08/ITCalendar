...
- (void)configureAppearance
{
    ...
    UIFont *todayTitleFont = self.calendar.appearance.todayTitleFont;
    
    if (![titleFont isEqual:_titleLabel.font]) {
        _titleLabel.font = titleFont;
    }
    if (self.dateIsToday && (![todayTitleFont isEqual:_titleLabel.font])) {
        _titleLabel.font = todayTitleFont;
    }
