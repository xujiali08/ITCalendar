...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _todayTitleFont = [UIFont systemFontOfSize:FSCalendarStandardTitleTextSize];
...
- (void)setTodayTitleFont:(UIFont *)titleFont
{
    if (![_todayTitleFont isEqual:titleFont]) {
        _todayTitleFont = titleFont;
        [self.calendar configureAppearance];
    }
}
